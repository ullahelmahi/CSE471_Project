...
const AboutUs = () => {
    return (
        <section className="bg-base-200 text-base-content px-6 py-16 mt-12">
            <div className="max-w-5xl mx-auto space-y-10">

                {/* Title */}
                <div className="text-center">
                    <h2 className="text-4xl font-bold text-primary mb-2">
                        Connecting People. Empowering Cities.
                    </h2>
                    <p className="text-base-content/70 text-lg">
                        ...
                        , your city’s dedicated internet partner.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 mt-2 text-base-content/80">
                ...
                <div>
                    ...
                    <p className="text-base-content/80">
                        We’re more than just an internet provider — we’re your{" "}
                        <strong>daily digital partner</strong>. Whether you're streaming, working, or studying,{" "}
                        <span className="text-secondary font-medium">
                            CityNet
                        </span>{" "}
                        is here to keep you connected.
                    </p>
                </div>
                ...
                <div className="bg-base-100 p-6 rounded-xl shadow">
                    ...
                    <p className="text-base-content/80">
                        <strong>Email:</strong> support@CityNet.com
                    </p>
                    <p className="text-base-content/80">
                        <strong>Website:</strong>{" "}
                        <a
                            className="link link-secondary"
                            href="http://www.CityNet.com"
                        >
                            www.CityNet.com
                        </a>
                    </p>
