...
const FtpPage = () => {
    return (
        <section className="bg-base-200 px-6 py-16 mt-12 text-base-content">
            <div className="max-w-5xl mx-auto space-y-10">
                ...
                <div className="bg-base-100 p-6 rounded-xl shadow space-y-4">
                    ...
                    <p className="text-base-content/80">
                        ...
                        through a secure and stable connection. At{" "}
                        <strong>CityNet</strong>, we provide high-speed FTP access
                        to let you enjoy local movies, software, games, and more
                        directly from our servers — without using your data cap.
                    </p>
                </div>
                ...
                <div className="bg-base-100 p-6 rounded-xl shadow space-y-4">
                    ...
                    <p className="text-sm text-base-content/60 mt-2">
                        Need help? See our{" "}
                        <a href="/help-center" className="link link-secondary">
                            Help Center
                        </a>{" "}
                        for step-by-step FTP client setup guides.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div className="collapse collapse-plus bg-base-100 mb-2">
                        ...
                        <div className="collapse-content text-base-content/80">
                            <p>
                                Yes! All FTP downloads are included with your plan
                                and do not count against your data usage.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="collapse collapse-plus bg-base-100 mb-2">
                        ...
                        <div className="collapse-content text-base-content/80">
                            <p>
                                Currently, upload access is only available to
                                authorized users. Please contact support for more
                                info.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="collapse collapse-plus bg-base-100">
                        ...
                        <div className="collapse-content text-base-content/80">
                            <p>
                                All FTP downloads use high-speed LAN routing, so
                                you can expect blazing-fast performance with
                                minimal latency.
                            </p>
                        </div>
                    </div>
                ...
                <div className="text-center mt-10">
                    <p className="text-base-content/70">
                        Need FTP login help or content requests?
                    </p>
                    <a href="/support" className="btn btn-primary mt-2">
